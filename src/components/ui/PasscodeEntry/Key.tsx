...
export const Key = ({ onPress, children, ariaLabel }: Props) => {
	...
	const backgroundStyle = useAnimatedStyle(
		() => ({
			backgroundColor: interpolateColor(pressProgress.value, [0, 1], [keyTokens.colors.background.normal, keyTokens.colors.background.pressed]),
		}),
	...
	return (
		<Pressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} aria-label={ariaLabel}>
