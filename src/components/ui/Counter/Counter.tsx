...
import { AccessibilityActionEvent, AccessibilityInfo, AccessibilityProps, View } from 'react-native';
...
export const Counter = ({
	...
	const [internalCount, setInternalCount] = useState(value !== undefined ? Math.min(Math.max(value, minValue), maxValue) : minValue);
