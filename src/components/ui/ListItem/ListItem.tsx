	...
	return (
		<>
			<Pressable onPress={onPress} role={!!onPress ? 'button' : 'listitem'} {...accessibilityProps}>
				{({ pressed }) => (
					<View style={[styles.itemContainer, !!onPress && pressed && styles.itemContainerPressed, StyleSheet.flatten(style)]}>
						{itemLeft}
						<View style={styles.itemContent}>
							...
							<Text variant="body2" color={variant === 'danger' ? 'sentimentNegative' : 'contentPrimary'} style={styles.text}>
								{text}
							</Text>
							{textBelow && (
								<Text variant="body3" color="contentTertiary">
